...
class Total_earning extends StatefulWidget {
  ...
  Total_earning({Key? key,this.vendorHomeResponse}) : super(key: key);
                  ...
                  child: Padding(
                    ...
                    child: Column(children: [
                      ...
                      SizedBox(
                        ...
                        widget.vendorHomeResponse!.data.totalEarning.details.isEmpty
                            ? Container(
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount:
                            widget.vendorHomeResponse?.data.totalEarning.details.length ?? 0,
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                'Booking Id-${widget.vendorHomeResponse?.data.totalEarning.details[index].bookingId??''}',
                                                style: TextStyle(
                                                    fontSize: 14,
                                        ...
                                        Expanded(
                                          ...
                                          child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  helper(key: 'Ground Title', value: '${widget.vendorHomeResponse?.data.totalEarning.details[index].grountTitle??''}'),
                                                  ...
                                                  helper(key: 'Amount', value: '${widget.vendorHomeResponse?.data.totalEarning.details[index].amount??''} To ${widget.vendorHomeResponse?.data.totalBooking.details[index].bookingTo??''}'),
                                                ],
                                              )),
                                        ),
                                      ]),
