...
class Previousbooking extends StatefulWidget {
  ...
  Previousbooking({Key? key,this.vendorHomeResponse}) : super(key: key);
                  ...
                  child: Padding(
                    ...
                    child: Column(children: [
                      ...
                      SizedBox(
                        ...
                        widget.vendorHomeResponse!.data.previousBooking.details.isEmpty
                            ? Container(
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount:
                            widget.vendorHomeResponse?.data.previousBooking.details.length ?? 0,
                                        ...
                                        Expanded(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                'Booking Id-${widget.vendorHomeResponse?.data.previousBooking.details[index].id??''}',
                                                style: TextStyle(
                                                    fontSize: 14,
                                        ...
                                        Expanded(
                                          ...
                                          child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  helper(key: 'Ground Title', value: '${widget.vendorHomeResponse?.data.previousBooking.details[index].groundTitle??''}'),
                                                  ...
                                                  helper(key: 'Time', value: '${widget.vendorHomeResponse?.data.previousBooking.details[index].bookingFrom??''} To ${widget.vendorHomeResponse?.data.totalBooking.details[index].bookingTo??''}'),
                                                ],
                                              )),
                                        ),
                                      ]),
