                          ...
                          : Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  var timeslot = timeSlot2[index].fromTime;
                                 ...
                                 /* TimeOfDay currentTime = TimeOfDay(
                                      hour: int.parse(timeSlot2[index].fromTime ?? ''),
                                      minute: 0);*/
                                  /*TimeOfDay newTime = currentTime.replacing(
                                      hour: currentTime.hour + 1);*/

                                  var CheckTime =
                                      "${datecontroller.text} ${timeSlot2[index].fromTime}:00.000";
