...
extension colors on ColorScheme {
  ...
  static const Color testline = Color(0xFF131313);
  static const Color test = Color(0xFF7B7A7A);
  static const Color btn = Color(0xFF5ACBEF);
  static const Color bgcolor = Color(0xFFFFFFFF);
  static const Color backcolor = Color(0xFFF3F3F3);
  static const Color greyColor = Color(0xffcdd2d9);
  static const Color verifieFieldColor = Color(0xff023664);
