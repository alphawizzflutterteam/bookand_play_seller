...
final Uri getUserLogin= Uri.parse('${baseUrl}vendor_login');
final Uri getVendorHomeData= Uri.parse('${baseUrl}vendor_home_details');
...
final Uri BookingGround = Uri.parse('${baseUrl}booking_by_vendor');
final Uri ApplyPromocode = Uri.parse('${baseUrl}applied_offer');
final Uri Addreview = Uri.parse('${baseUrl}ground_review');
final Uri getBookind = Uri.parse('${baseUrl}ground_booking_history');
final Uri deleteGround = Uri.parse('${baseUrl}ground_delete');
final Uri updateGround = Uri.parse('${baseUrl}ground_update');
final Uri vendorwallet = Uri.parse('${baseUrl}vendor_wallet');
final Uri getNotification = Uri.parse('${baseUrl}get_notification');
final Uri getCancleBooking = Uri.parse('${baseUrl}get_cancel_booking');
final Uri getOfflineBooking = Uri.parse('${baseUrl}offline_ground_booking_history');
final Uri canclebookingstatus = Uri.parse('${baseUrl}cancel_booking_status_update');
